...
def run_sanity_check(lm, vocab_index):
    """
    (1) The language model must return valid probabilities for a few contexts. This checks that
    your model can take sequences of different lengths and contexts of different lengths without crashing.
    (2) Next character distribution must agree with get_log_prob_sequence
